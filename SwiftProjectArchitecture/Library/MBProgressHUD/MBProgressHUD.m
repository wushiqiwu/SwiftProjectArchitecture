...
+ (MB_INSTANCETYPE)showHUDAddedTo:(UIView *)view animated:(BOOL)animated graceTime:(float)graceTime{
...
- (void)drawRect:(CGRect)rect {
	...
	if (self.dimBackground) {
		...
		CGFloat gradColors[8] = {0.15f,0.15f,0.15f,0.15f,0.15f,0.15f,0.15f,0.15f};
